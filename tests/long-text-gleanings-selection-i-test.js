/**
 * Test Case: Long Text - Gleanings Selection I
 *
 * Synthetic test with added noise to simulate speech-to-text errors.
 * Expected to match: gleanings-writings-bahaullah paragraph 1
 *
 * Run with: npm start, then in browser console:
 * import { runTest } from './tests/long-text-gleanings-selection-i-test.js';
 * runTest(findBestMatch, searchIndex);
 */

export const testCase = {
  // Noisy transcribed text
  transcribedText: `translated by shoghi effendi`,
  ...
  correctParagraphText: `Translated By Shoghi Effendi`,
...
export function runTest(findBestMatch, searchIndex) {
  console.log('=== Long Text - Gleanings Selection I ===\n');
