/**
 * Test Case: Unique Opener - Kitáb-i-Íqán Part One Opening
 *
 * Synthetic test with clean text.
 * Expected to match: kitab-i-iqan paragraph 2
 *
 * Run with: npm start, then in browser console:
 * import { runTest } from './tests/unique-opener-kit-b-i-q-n-part-one-opening-test.js';
...
export function runTest(findBestMatch, searchIndex) {
  console.log('=== Unique Opener - Kitáb-i-Íqán Part One Opening ===\n');
